...
S.scene_context = 0 ;                % 0=patch only, 1=patch in context
...
S.rating_type = 'Meaningfulness Rating' ;   % String listed above Likert Scale
...
for s=1:length(S.patch_scale) 
    ...
    for k=1:size(fin_jobs{s},2)
        ...
        %-- Add question about age range        
        fprintf(dfid,'[[Block:Age]]\n\n');
        fprintf(dfid,'[[Question:MC]]\n');
        fprintf(dfid,'<div style="text-align:center;">\n');
        fprintf(dfid,'What is your age?\n');
        fprintf(dfid,'</div>\n');
        fprintf(dfid,'\n');
        fprintf(dfid,'[[Choices]]\n');        
        fprintf(dfid,'18-24 years old\n');
        fprintf(dfid,'25 years or older\n');
        %fprintf(dfid,'55-64 years old\n');
        %fprintf(dfid,'65 years or older\n');
        fprintf(dfid,'\n');
        fprintf(dfid,'[[PageBreak]]\n\n');
