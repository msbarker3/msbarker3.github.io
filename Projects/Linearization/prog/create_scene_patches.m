...
P.path = 'MMap_pathstr' ;   
P.scene_in = fullfile(eval(P.path),'data','scene_images','SDesc01_half') ; 
P.patch_out = {fullfile(eval(P.path),'data','patch_stimuli','sdesc01fine')
               fullfile(eval(P.path),'data','patch_stimuli','sdesc01coarse')} ;
