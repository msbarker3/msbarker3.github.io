% GENERATE_meaning_mapS - Loads patch rating structure and image to
%      generate rating map
%
...
I.scene_in = fullfile(I.path,'data','scene_images','SDesc01_half') ; 
I.rating_in = fullfile(I.path,'data','pixel_data','sdesc01',task,'combined') ;
I.map_out = fullfile(I.path,'data','sdesc01','meaning_maps','raw') ;
I.map_visuals = fullfile(I.path,'data','sdesc01','meaning_maps','img') ;
I.map_scaled_out = fullfile(I.path,'data','sdesc01','meaning_maps','scaled') ;
