...
I.rating_in = fullfile(I.path,'data','pixel_data',group,task,'combined') ;
I.map_out = fullfile(I.path,'data',group,'meaning_maps','raw') ;
I.map_visuals = fullfile(I.path,'data',group,'meaning_maps','img') ;
I.map_scaled_out = fullfile(I.path,'data',group,'meaning_maps','scaled') ;
