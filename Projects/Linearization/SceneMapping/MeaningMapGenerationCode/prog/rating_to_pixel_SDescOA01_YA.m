...
P.patch_in = {fullfile(P.path,'data','patch_data',group,task,'fine')
              fullfile(P.path,'data','patch_data',group,task,'coarse')} ;
P.pixel_out = {fullfile(P.path,'data','pixel_data',group,task,'fine')
               fullfile(P.path,'data','pixel_data',group,task,'coarse')} ;
P.pixel_out_combined = fullfile(P.path,'data','pixel_data',group,task,'combined');
